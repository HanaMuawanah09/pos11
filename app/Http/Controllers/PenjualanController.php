...
class PenjualanController extends Controller
{
   ...
   public function edit(Penjualan $penjualan)
    ...
    public function update(Request $request, Penjualan $penjualan)
    {
        ...
        // Kalau QRIS, anggap uang dibayar pas sesuai total (tidak ada kembalian)
        $uangDibayar = $request->payment_method === 'CASH'
            ? (float) $request->uang_dibayar
            : $total;

        if ($uangDibayar < $total) {
            return back()->with('errors', 'Uang yang dibayarkan kurang dari total belanja');
        }
        ...
        return redirect()
            ...
            ->with('success', 'Transaksi berhasil diselesaikan. Kembalian: Rp ' . number_format($kembalian));
    }
